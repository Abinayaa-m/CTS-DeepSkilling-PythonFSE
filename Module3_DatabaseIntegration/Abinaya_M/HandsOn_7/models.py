...
class Student(Base):
    ...
    is_active = Column(Boolean, default=True) #Q98 ADDED is_active to alter the table and add a new column to the students table
...
#added CourseSchedule model to create a new table course_schedules with the specified columns and relationships.(Q102)
